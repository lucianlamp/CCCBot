...
1. **First-run check:** If any of `CLAUDE.md`, `SOUL.md`, `USER.md`, `CRONS.md` are missing from the project root, invoke `/ccc-setup` to generate them and guide the user through configuration.
