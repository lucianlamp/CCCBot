...
1. **First-run check:** If any of `SOUL.md`, `USER.md`, `CRONS.md` are missing from the project root, invoke the `/setup` skill to generate them from templates before proceeding.
